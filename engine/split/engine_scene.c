...
AUTORUN {
    ...
    obj_ctor[OBJTYPE_camera] = (void(*)(void))camera_ctor;
}
...
AUTORUN {
    ...
    obj_ctor[OBJTYPE_node] = (void(*)(void))node_ctor;
}
...
AUTORUN {
    ...
    obj_ctor[OBJTYPE_scene] = (void(*)(void))scene_ctor;
    obj_dtor[OBJTYPE_scene] = (void(*)(void))scene_dtor;
    obj_draw[OBJTYPE_scene] = (int(*)(void))scene_draw;
}
