...
char *rpc_full(unsigned id, const char* method, unsigned num_args, char *args[]) {
    ...
    if( found ) {
        switch(found->function_hash) {
            case RPC_SIGNATURE_i_iii: return va("%d %d", id, (int)(intptr_t)((void*(*)(int,int,int))found->function)(atoi(args[0]), atoi(args[1]), atoi(args[2])) );
            case RPC_SIGNATURE_i_ii:  return va("%d %d", id, (int)(intptr_t)((void*(*)(int,int))found->function)(atoi(args[0]), atoi(args[1])) );
            case RPC_SIGNATURE_i_s:   return va("%d %d", id, (int)(intptr_t)((void*(*)(char*))found->function)(args[0]) );
            case RPC_SIGNATURE_s_s:   return va("%d %s", id, (char*)((char*(*)(char*))found->function)(args[0]) );
            case RPC_SIGNATURE_s_v:   return va("%d %s", id, (char*)((char*(*)(void))found->function)() );
            case RPC_SIGNATURE_v_v:   return ((void(*)(void))found->function)(), va("%d", id);
            case RPC_SIGNATURE_v_s:   return ((void(*)(char*))found->function)(args[0]), va("%d", id);
            default: break;
        }
    }
    return va("%d -1", id);
